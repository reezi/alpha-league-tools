...
normal_attack_hit --> shield_self: fierce counter (weaponry,shield)
normal_attack_hit --> innerfire_self: wild power (weaponry,innerfire)
normal_attack_hit --> vulnerable_enemy: devouring blade (weaponry,vulnerable)
...
mech --> damage_dealt: self destruct (mech)
...
damage_taken --> innerfire_self: arrogant aura (innerfire)
...
damage_taken --> frost_enemy: frost counter (frost)
...
damage_taken --> toxin_enemy: toxin backlash (toxin)
